...
/// Number of out of order packets we keep track of for reports. Sigil: raised from 100 so a
/// sub-second Wi-Fi stall at 1080p60 (about 250 packets) can still be requested again.
const MAX_MISORDER: u64 = 1000;
