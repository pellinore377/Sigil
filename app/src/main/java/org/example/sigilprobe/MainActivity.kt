        ...
        setSigilContent {
            ...
            SigilApp(NativeCore::palette, NativeCore::analyze, messenger.state, messenger::command,
                ...
                overlay = {
                    ...
                    messenger.deviceLink?.let { flow -> DeviceLinkDialog(flow, messenger.deviceLinkBusy, messenger.deviceLinkIssue) { action, qr -> messenger.command("device_link", mapOf("action" to action, "qr" to qr)) } }
