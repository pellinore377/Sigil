...
import org.sigil.nativeTemporalPreview
...
internal fun ComponentActivity.setSigilContent(content: @Composable () -> Unit) {
    ...
    setContent {
        ...
        CompositionLocalProvider(org.sigil.LocalMaterialPlatform provides AndroidMaterials, org.sigil.LocalMaterialOverlay provides { scene, modifier -> org.sigil.MaterialTimelineOverlay(scene,modifier) }, org.sigil.LocalSolidMaterial provides { value, progress, modifier -> org.sigil.MaterialMessages(value,progress,modifier) }, org.sigil.LocalCodePreview provides org.sigil.NativeCore::codePreview, org.sigil.LocalStructuredPreview provides ::nativeStructuredPreview, org.sigil.LocalBuilderTimezone provides java.util.TimeZone.getDefault().id, org.sigil.LocalBuilderSource provides org.sigil.NativeCore::builderSource, org.sigil.LocalHelpCatalog provides org.sigil.NativeCore::helpCatalog, org.sigil.LocalTemporalPreview provides ::nativeTemporalPreview, org.sigil.LocalMotionBlur provides (Build.VERSION.SDK_INT>=31), org.sigil.LocalMotionVisible provides visible, org.sigil.LocalTextMotionSeeds provides org.sigil.NativeCore::motionSeeds, org.sigil.LocalEditorAnalysis provides org.sigil.NativeCore::editor, org.sigil.LocalSensitiveCopy provides { value ->
