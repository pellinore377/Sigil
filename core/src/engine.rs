...
impl Engine {
    ...
    pub async fn dispatch(self: &Arc<Self>, req: Request) -> Reply {
        ...
        match req.req.as_str() {
            ...
            "media.gifFrames" => crate::media::gif::frames(self.clone(), p).await,
            "video.play" => crate::media::video_play(self.clone(), p).await,
            "video.pause" => crate::media::video_pause(self.clone(), p).await,
            "video.position" => crate::media::video_position(self.clone(), p).await,
