...
Android revision **9 tests** pass and cover persistent tab/conversation headers, rounded footer corners, reversible inline forms, keyboard height, delayed theme saves, voice drafts and bounded QR preview. Messaging **13 tests** and layout **3 tests** pass, including 200% text. Synthetic sign-in tests disable semantic autofill to prevent external password-save prompts. Real camera/voice capture **2 tests** pass, including playback before staging. Contact-request **4 tests** pass through acceptance, verification, encrypted messaging, retries, tamper rejection and incoming-request visibility.
