...
fn schema26_rebuild_counts_retained_contacts_and_recipient_grants_once_including_restore() {
    ...
    .unwrap();
    db.execute_batch("DROP TABLE web_oidc; DROP TABLE web_sessions; DROP TABLE web_owner; DROP TABLE deleted_accounts; ALTER TABLE private_groups DROP COLUMN blocked;").unwrap();
