...
fn android_bootstrap_is_authenticated_project_bound_and_restore_safe() {
    ...
    db.execute_batch("DROP TABLE push_android; DROP TABLE link_relay; PRAGMA user_version=33;").unwrap();
