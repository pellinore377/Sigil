...
data class Transfer(val request: String, val peer: String, val name: String, val bytes: Long, val phase: String)
data class VoiceState(val phase: String = "Idle", val peer: String = "", val seconds: Long = 0, val levels: List<Float> = emptyList())
