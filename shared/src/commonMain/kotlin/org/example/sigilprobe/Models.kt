...
data class ChatMessage(val id: String, val author: String, val text: String, val mine: Boolean, val time: String,
    ...
    val threadAuthor: String? = null, val threadMessage: String? = null, val editable: Boolean = true, val kind: String = "Text", val peer: String = "", val attachment: AttachmentDetails? = null, val parts: List<MessagePart> = emptyList(), val threadPreview: String? = null, val replyAuthor: String? = null, val replyMine: Boolean = false)
