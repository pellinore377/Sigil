...
fun Composer(state: TextFieldState, analyze: (String) -> String, modifier: Modifier = Modifier, showTools: Boolean = true) {
    ...
    Column(modifier, verticalArrangement = Arrangement.spacedBy(4.dp)) {
        ...
        BasicTextField(state,
            modifier = Modifier.fillMaxWidth().heightIn(min = 64.dp, max = 144.dp).testTag("composer")
                .semantics { contentDescription = "Message" }
                .focusRequester(editorFocus).onFocusChanged { editorFocused = it.isFocused }
                .border(1.dp, MaterialTheme.colorScheme.outline, MaterialTheme.shapes.small).padding(10.dp)
                .onPreviewKeyEvent {
